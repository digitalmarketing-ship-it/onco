        ...
        <div class="row">
            ...
            <div class="images-column col-lg-6 col-md-12 col-sm-12 order-2" style="margin-top:-20px;">
                <div class="inner-column" style="padding-left:50px;">
                    <figure class="image-1"><img src="image_website/envelope.png" alt="Video Image" loading="lazy" style="border-radius:20px; height: 100% !important;width: 100% !important;box-shadow: 0 0.5rem 1.5rem #03bfb3;"></figure>
                </div>
            </div>
        </div>
    </div>        
        ...
        <div class="auto-container">
            <div class="row">
                <div class="images-column col-lg-6 col-md-12 col-sm-12 order-2">
                     <div class="inner-column" style="padding-left:50px;">
                        <figure class="image-1"><img src="image_website/faq_envelope.png" alt="Video Image" loading="lazy" style="box-shadow:0 0.5rem 1.5rem #03bfb3; border-radius:20px; height: 100% !important;width: 100% !important;"></figure>
                         <!-- <div class="link-box">
